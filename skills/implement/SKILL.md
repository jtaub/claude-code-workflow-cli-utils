...
Use the `gh` CLI to fetch $ARGUMENTS — read the issue title, description, and view any attachments such as screenshots.
...
2. Follows a TDD approach — write/update tests before implementation, aim to cover 100% of every user-facing behavior
