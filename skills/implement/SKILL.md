---
name: implement
description: Use when the user wants to implement a GitHub issue with a TDD approach, producing a step-by-step implementation plan. Invoke with /implement <issue-url>
---
